LoginToAlfresco
    # vURL contient l'adresse URL de la page web, vUsername contient le login
    # vPassword contient le mot de passe, vTitle contient le titre de la page de login 
    [Arguments]    ${vURL}    ${vUsername}    ${vPassword}    ${vTitle}
    ...
    Element Text Should Be    xpath://*[@id="HEADER_TITLE"]/span    Tableau de bord de ${vUsername}
